...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    ...
    'bs3': {
      ...
      errorTpl:    '<div class="editable-error help-block" data-ng-if="$error" data-ng-bind="$error"></div>',
      buttonsTpl:  '<span class="editable-buttons"></span>',
      submitTpl:   '<button type="submit" class="btn btn-success btn-xs"><span></span></button>',
      cancelTpl:   '<button type="button" class="btn btn-danger btn-xs" ng-click="$form.$cancel()">'+
                     '<span></span>'+
                   '</button>',
      resetTpl:    '<button type="reset" class="btn btn-danger">clear</button>',
