(function() {
  ...
  function toastr($animate, $injector, $document, $rootScope, $sce, toastrConfig, $q) {
    ...
    function errorhall(message, title, optionsOverride) {
      var type = _getOptions().iconClasses.errorhall;
      return _buildNotification(type, message, title, optionsOverride);
    }
    ...
    function successhall(message, title, optionsOverride) {
      var type = _getOptions().iconClasses.successhall;
      return _buildNotification(type, message, title, optionsOverride);
    }
  ...
  angular.module('toastr')
    .constant('toastrConfig', {
      ...
      iconClasses: {
        ...
        successhall: 'toast-successhall',
        errorhall: 'toast-errorhall'
      },
      maxOpened: 0,
